...
from flask_integrum.users.forms import (RegistrationForm, LoginForm, UpdateAccountForm,
...
def login():
    ...
    if form.validate_on_submit():
        ...
        if user and bcrypt.check_password_hash(user.password, form.password.data):
            ...
            return redirect(next_page) if next_page else redirect(url_for("main.hem"))      
        else:
